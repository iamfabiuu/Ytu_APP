/*
 * Ícones dos modos de deslocamento: pessoa andando e bicicleta.
 *
 * Desenhos do Material Design Icons (Google), licença Apache 2.0:
 * https://github.com/google/material-design-icons
 * (versões "directions_walk" e "directions_bike", estilo preenchido)
 *
 * São SVG embutidos: não precisa instalar nada nem criar imagens.
 * Herdam a cor do texto (currentColor) e o tamanho do `className`
 * (ex.: "size-5").
 */
